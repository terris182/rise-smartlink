...
export default function SmartLinkClient({ link }) {
  ...
  const platforms = [
    ...
    },
    {
      key: 'apple_music',
      label: 'Apple Music',
      url: link.appleMusicUrl,
      color: '#FA243C',
      icon: (
        <svg viewBox="0 0 24 24" width="30" height="30" fill="#FA243C">
    ...
    },
    {
      key: 'soundcloud',
      label: 'SoundCloud',
      url: link.soundcloudUrl,
      color: '#FF5500',
      icon: (
        <svg viewBox="0 0 24 24" width="30" height="30" fill="#FF5500">
